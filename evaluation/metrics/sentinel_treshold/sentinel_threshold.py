...
def get_threshold_stats(_project, _attack_list, _thresholds):
    benign_filter = {
...
if __name__ == '__main__':
    projects = ["fedstellar-mnist-treshold-eval", "fedstellar-fmnist-treshold-eval", "fedstellar-cifar10-treshold-eval"]
    ...
    for project in projects:
        get_threshold_stats(project, attack_list, thresholds)
